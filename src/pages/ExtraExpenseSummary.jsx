...
//     const { data: extraShoppingData, isLoading, isError } = useExtraShoppingWithCategoryQuery(managerId, { skip:skip })
...
export default function MealExpenseSummary() {
    ...
    const managerId = user?.role === 'admin' ? user?._id : user?.manager
    console.log(managerId)
    const { data: marketingData, isLoading, isError } = useExtraShoppingWithCategoryQuery(managerId, { skip: skip })
